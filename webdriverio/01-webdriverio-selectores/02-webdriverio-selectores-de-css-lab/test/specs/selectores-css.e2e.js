describe('Selectores de CSS', () => {
  ...
  it('debería estar mostrándose la tarjeta del producto "Nothing Phone 3"', async () => {
    // await browser.url('http://localhost:3002/tienda3000-v1.html')
  ...
  it('debería haber 4 productos en la tienda', async () => {
    ...
    const productos = await $$('.caja-producto')
  ...
  it('debería encontrar el botón de Añadir al carrito del Macbook mini', async () => {
    ...
    const boton = await $('[data-id="1001"]')
    await expect(boton).toBeDisplayed()
  })

  it('debería encontrar el botón de Añadir al carrito de Auriculares Sony', async () => {
